...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in authentication_service_pb2_grpc.py depends on'
...
def add_LoginServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('authentication.Login', rpc_method_handlers)
